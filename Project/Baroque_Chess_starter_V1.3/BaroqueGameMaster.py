...
def runGame():
    ...
    while not FINISHED:
        ...
        # print('playerResult = {}'.format(playerResult))
        ...
        try:
            ...
            # print(type(newState.board))
            print('newState =\n{}move = {}'.format(newState, move))
            WINNER = other_side
            FINISHED = True
...
def timeout(func, args=(), kwargs={}, timeout_duration=1, default=None):
    ...
    if pt.isAlive():
        ...
        if USE_HTML: gameToHTML.reportResult(
            "Player " + CURRENT_PLAYER + " took too long (%04f seconds) and thus loses." % diff)
